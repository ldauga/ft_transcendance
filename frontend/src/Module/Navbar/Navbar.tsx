...
function NavBar(props: { openFriendConversFromProfile: boolean, dataFriendConversFromProfile: { id: number, login: string, nickname: string, profile_pic: string }, setOpenFriendConversFromProfile: Function }) {
	...
	// 	console.log("total: ", persistantReducer.chatNotifReducer.total);
	// 	//console.log("persistantReducer.chatNotifReducer.convers.name: ", persistantReducer.chatNotifReducer.convers.name, ", newNotif.name: ", newNotif.name);
	...
	// 	console.log("data.login_sender: ", data.login_sender, ", userOrRoom: ", data.userOrRoom);
	...
	utilsData.socket.on('newChatNotif', function (newNotif: { name: string, userOrRoom: boolean }) {
		console.log("newChatNotif");
		console.log("total: ", persistantReducer.chatNotifReducer.total);
		//console.log("persistantReducer.chatNotifReducer.convers.name: ", persistantReducer.chatNotifReducer.convers.name, ", newNotif.name: ", newNotif.name);
		// if (!(persistantReducer.chatNotifReducer.convers.name == newNotif.name && persistantReducer.chatNotifReducer.convers.userOrRoom == newNotif.userOrRoom))
		console.log("conversNotif.name: ", conversNotif.name, ", userOrRoom: ", conversNotif.userOrRoom);
		console.log("newNotif.name: ", newNotif.name, ", userOrRoom: ", newNotif.userOrRoom);
