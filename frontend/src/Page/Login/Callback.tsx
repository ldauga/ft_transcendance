...
export default function Callback() {
    ...
    function turnOn2fa(value: string) {
        axios.get('https://10.64.1.68:5001/auth/2fa/verify/' + value, { withCredentials: true })
    ...
    if (persistantReducer.userReducer.user === null) {
        axiosConfig.get("https://10.64.1.68:5001/user/userExist/").then((item) => { setUser(item.data); }).catch((err) => setUser(null))
    }
