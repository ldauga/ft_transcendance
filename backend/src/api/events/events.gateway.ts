...
export class EventsGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect {
  ...
  async createInvitationRequest(client: Socket, data: any) {
    ...
    if (!verifBan) {
      ...
      //const invitationRequestReturn = await this.http.post('https://10.3.3.5:5001/invitationRequest', invitationRequest);
  ...
  async removeInvitationRequest(client: Socket, data: any) {
    ...
    //const invitationRequestReturn = await this.http.post('https://10.3.3.5:5001/invitationRequest/' + data.id_user1 + '/' + data.id_user2);
  ...
  async addFriend(client: Socket, data: any) {
    ...
    //const addFriendReturn = await this.http.post('https://10.3.3.5:5001/friendList/', newFriend);
  ...
  async removeFriend(client: Socket, data: any) {
    ...
    //const removeFriendReturn = await this.http.post('https://10.3.3.5:5001/friendList/' + data.id_user1 + '/' + data.id_user2);
  ...
  async createChatRooms(client: Socket, data: any) {
    ...
    //const roomReturn = await this.http.post('https://10.3.3.5:5001/rooms', newRooms);
    ...
    //const participantReturn = await this.http.post('https://10.3.3.5:5001/participants', newParticipant);
  ...
  async removeRoom(client: Socket, data: any) {
    ...
    //const removeRoomReturn = await this.http.post('https://10.3.3.5:5001/rooms/' + data.id + '/' + data.room_name);
    ...
    if (removeRoomReturn) {
      ...
      if (_room != null) {
        ...
        while (i < _room.users.length) {
          //const removeParticipantReturn = await this.http.post('https://10.3.3.5:5001/participants/' + _room.users[i].username + '/' + _room.name);
        ...
        //}
        //const removeAllRoomMessagesReturn = await this.http.post('https://10.3.3.5:5001/messages/removeAllRoomMessages/', toRemoveMsg);
  ...
  async joinChatRoom(client: Socket, data: any) {
    ...
    //const tmp = 'https://10.3.3.5:5001/rooms/' + data.user_id + '/' + data.user_login + '/' + data.room_id + '/' + data.room_name + '/' + tmpPassword + '/';
  ...
  async changePassword(client: Socket, data: any) {
    ...
    let verif = false;
    //const checkIfAdmin = await http.get('https://10.3.3.5:5001/participants/checkAdmin/' + data.login + '/' + data.room_name);
    ...
    if (checkIfAdmin == true) {
      ...
      //const changeMdpReturn = await http.post('https://10.3.3.5:5001/rooms/changePassword/', newMdp);
  ...
  async createAdmin(client: Socket, data: any) {
    ...
    let verif = false;
    //const checkIfOwner = await this.http.get('https://10.3.3.5:5001/rooms/checkIfOwner/' + data.id_sender + '/' + data.login_sender);
    const checkIfOwner = await this.RoomsService.checkIfOwner(data.id_sender, data.login_sender);
    if (checkIfOwner == true)
      verif = true;
    // const checkIfAdmin = await this.http.get('https://10.3.3.5:5001/participants/checkAdmin/' + data.login_sender + '/' + data.room_name);
    const checkIfAdmin = await this.ParticipantsService.checkAdmin(data.login_sender, data.room_name);
    if (checkIfAdmin == true)
      verif = true;
    //const checkParticipant = await this.http.get('https://10.3.3.5:5001/participants/checkIfAdminOrParticipant/' + data.login_admin + '/' + data.room_name);
    ...
    if (checkParticipant == true && verif == true) {
      ...
      //const participantReturn = await this.http.post('https://10.3.3.5:5001/participants/admin', newParticipant);
  ...
  async createBan(client: Socket, data: any) {
    ...
    //const checkFriendship = await this.http.get('https://10.3.3.5:5001/friendList/' + data.id_banned + '/' + data.id_sender);
    ...
    if (checkFriendship == true) {
      this.logger.log(`${client.id} remove Friend`);
      //const removeFriendReturn = await this.http.post('https://10.3.3.5:5001/friendList/' + data.id_banned + '/' + data.id_sender);
  ...
  async createRoomBan(client: Socket, data: any) {
    ...
    if (checkParticipant) {
      ...
      //const removeParticipantReturn = await this.http.post('https://10.3.3.5:5001/participants/' + data.login_banned + '/' + data.room_name);
  ...
  async createRoomMute(client: Socket, data: any) {
    ...
    //const checkParticipant = await http.get('https://10.3.3.5:5001/participants/check/' + data.login_muted + '/' + data.room_name);
  ...
  async removeRoomMute(client: Socket, data: any) {
    ...
    const tmp = 'https://10.3.3.5:5001/muteList/removeRoomMute/' + data.room_id + '/' + data.login_muted;
